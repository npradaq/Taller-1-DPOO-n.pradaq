...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar país de un atleta dado");
		System.out.println("14. Salir de la aplicación\n");
	}

	/*
	 * Le mustra al usuario el país del atleta dado su nombre
	 */
	private void ejecutarPaisAtleta() {
		String nombreAtletaConsulta = input("Por favor ingrese el nombre del atleta: ");

		String paisAtleta = calculadora.paisPorNombreAtleta(nombreAtletaConsulta);

		if(paisAtleta != ""){
			System.out.println("\nEl pais al que el atleta " + nombreAtletaConsulta + " representa es: " + paisAtleta + ".");
		}
		else{
			System.out.println("\nNo se pudo encontrar el pais al que " + nombreAtletaConsulta + " representa.");
		}
